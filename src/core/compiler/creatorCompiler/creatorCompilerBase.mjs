 ...
 *
 */
import { main_memory, status, update_binary, architecture, backup_stack_address, backup_data_address, stats, stats_value, newArchitecture, ENDIANNESSARR, WORDSIZE, BYTESIZE } from "../../core.mjs";
