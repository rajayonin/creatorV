...
import {
    creator_memory_findaddress_bytag,
...
var notifications = []
/*Available examples*/
export var example_set_available = []
...
export function assembly_compiler() {
    ...
    if (update_binary.instructions_binary != null) {
        for (let i = 0; i < update_binary.instructions_binary.length; i++) {
            ...
            address =
                parseInt(instructions[instructions.length - 1].Address, 16) + 4
        }
    } else {
  ...
  architecture.components[0].elements[0].default_value  = bi_intToBigInt(address,10) ;*/
                ...
                switch (architecture.directives[i].action) {
                    ...
                    case "global_symbol":
                        ...
                        while (isGlobl) {
                            ...
                            for (
                                let z = 0;
                                z < architecture.directives.length;
                                z++
                            ) {
                                if (
    ...
    if (update_binary.instructions_binary != null) {
        for (let j = 0; j < instructions.length; j++) {
            if (instructions[j].Label != "") {
                for (
                    let i = 0;
                    i < update_binary.instructions_tag.length;
                    i++
                ) {
                    if (
                        instructions[j].Label ==
                        update_binary.instructions_tag[i].tag
                    ) {
                        update_binary.instructions_tag[i].addr =
            ...
            if (
                ...
                for (let z = 0; z < instructions.length && exit === 0; z++) {
                    if (instructions[z].Label == instructionParts[j]) {
                        ...
                        for (let w = 0; w < instructionParts.length; w++) {
                            newInstruction =
                                newInstruction + instructionParts[w]
                        ...
                        for (
                            let w = 0;
                            w < instructions.length && exit === 0;
                            w++
                        ) {
                            let aux =
                                "0x" +
                                pending_instructions[i].address.toString(16)
                        ...
                        for (
                            ...
                            if (aux == instructions[w].Address) {
                                ...
                                instructions_binary[w - numBinaries].loaded =
                                    iload.substring(
                                        0,
                                        iload.length - (startbit + 1),
                                    ) +
                                    bin.padStart(fieldsLength, "0") +
                                    iload.substring(
                                        iload.length - stopbit,
                                        iload.length,
                                    )
                                exit = 1
                            }
                ...
                if (ret1.exit === 1) {
                    ...
                    for (let w = 0; w < instructions.length; w++) {
                        let aux =
                            "0x" + pending_instructions[i].address.toString(16)
                        if (aux == instructions[w].Address) {
                            instructions[w].loaded = newInstruction
                        }
                    }
                                ...
                                if (aux == instructions[w].Address) {
                                    instructions_binary[
                                        ...
                                        instructions_binary[
                                            ...
                                            0,
                                            instructions_binary[w - numBinaries]
                                                .loaded.length -
                                                (startbit + 1),
                                        ) +
                                        bin.padStart(fieldsLength, "0") +
    ...
    if (update_binary.instructions_binary != null) {
        for (let i = 0; i < update_binary.instructions_binary.length; i++) {
            ...
            var auxAddr = parseInt(
                update_binary.instructions_binary[i].Address,
                16,
            )
        ...
        if (extern.length === 0 && instructions_tag[i].tag != "") {
            ...
            for (let j = 0; j < extern.length; j++) {
                if (
                    ...
                    instructions_tag[i].tag =
                        instructions_tag[i].tag + "_symbol"
                    instructions_tag[i].globl = false
                    break
                        ...
                        while (isByte) {
                            ...
                            if (token.match(/^'(.*?)'$/)) {
                                ...
                                auxTokenString = value[1].padStart(
                                    2 *
                                        parseInt(
                                            architecture.directives[j].size,
                                        ),
                                    "0",
                                )
                                if (value[1].length === 0) {
            ...
            if (
                ...
                for (let i = 0; i < instructions.length; i++) {
                    if (instructions[i].Label != "") {
                        ...
                        tag_instructions[
                            parseInt(instructions[i].Address, 16)
                        ] = instructions[i].Label
                    }
                }
    ...
    for (
        ...
        if (architecture.instructions[i].name != instructionParts[0]) {
            ...
            if (oriInstruction.search(re) == -1) {
                ...
                for (let j = i + 1; j < architecture.instructions.length; j++) {
                    if (architecture.instructions[j].name == token) {
                        ...
                        for (let k = 1; k < numToken; k++) {
                            if (
                                architecture.instructions[j].fields[k].type !=
                                "cop"
                            ) {
                                if (isPseudo === false) {
                                    next_token()
                ...
                for (
                    let i = 0;
                    i < architecture.pseudoinstructions.length;
                    i++
                ) {
                    if (architecture.pseudoinstructions[i].name == token) {
                        numToken =
                    ...
                    case "INT-Reg":
                        ...
                        for (
                            ...
                            if (
                                ...
                                for (
                                    let z = 0;
                                    z < architecture_hash.length;
                                    z++
                                ) {
                                    for (
                                        let w = 0;
                                        w <
                                        architecture.components[z].elements
                                            .length;
                                        w++
                                    ) {
                                        if (
                                            architecture.components[z].elements[
                                                w
                                            ].name.includes(token) !== false &&
                                            architecture.components[z].type ==
                                                "int_registers"
                                        ) {
                                            //TODO:check
                                            validReg = true
                        ...
                        for (
                            ...
                            if (
                                ...
                                fieldsLength = getFieldLength(
                                    ...
                                    architecture.instructions[i].fields[a]
                                        .startbit,
                                    architecture.instructions[i].fields[a]
                                        .stopbit,
                                    a,
                                ...
                                if (token.match(/^0x/)) {
                                    ...
                                    if (
                                        float2bin(parseFloat(token)).length >
                                        fieldsLength
                                    ) {
                                        resultPseudo =
                                            pseudoinstruction_compiler(
                                    ...
                                    inm = (parseInt(token, 10) >>> 0).toString(
                                        2,
                                    )
                                    inm = inm.substring(
                                        inm.length - fieldsLength,
                                        inm.length,
                                    )
                                }
                                if (validTagPC === true) {
                                    ...
                                    if (
                                        ...
                                        architecture.instructions[i].fields[a]
                                            .startbit -
                                            architecture.instructions[i].fields[
                                                a
                                            ].stopbit +
                                            1
                                    ) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    fieldsLength = architecture.instructions[
                                        i
                                    ].fields[a].startbit
                                        .map(
                                            (b, iii) =>
                    ...
                    default:
                        ...
                        for (
                            ...
                            if (
                                ...
                                /**/
                                if (
                                    typeof architecture.instructions[i].fields[
                                        a
                                    ].startbit == "object"
                                ) {
                                    fieldsLength = architecture.instructions[
                                        i
                                    ].fields[a].startbit.reduce(
                                        (t, cv, ind) => {
                                            t = !ind ? 0 : t
                                            t +
                                                (cv -
                            ...
                            if (
                                architecture.instructions[i].fields[a].type ==
                                "cop"
                            ) {
                                fieldsLength =
                                    architecture.instructions[i].fields[a]
                                ...
                                binary =
                                    ...
                                    architecture.instructions[i].fields[
                                        a
                                    ].valueField.padStart(fieldsLength, "0") +
                                    binary.substring(
                                        binary.length -
                                            architecture.instructions[i].fields[
                                                a
            ...
            if (validTagPC === false && resultPseudo == -3) {
                ...
                if (pending === false) {
                    ...
                    for (let pos = 0; pos < instructions.length; pos++) {
                        if (
                            parseInt(instructions[pos].Address, 16) >
                            pendingAddress
                        ) {
                ...
                if (resultPseudo == -3) {
                    ...
                    if (pending === false) {
                        ...
                        address =
                            address + 4 * architecture.instructions[i].nwords
                    } else {
                        for (let pos = 0; pos < instructions.length; pos++) {
                            if (
                                parseInt(instructions[pos].Address, 16) >
...
function executeCode(code, prefix) {
    const cleanCode = code
        ...
        .replace(/\b([a-zA-Z_][a-zA-Z0-9_]*)\b(?!\s*=)/g, (match, v) => {
            return Object.prototype.hasOwnProperty.call(globalThis, prefix + v)
                ? prefix + v
                : match
        })
...
function pseudoinstruction_compiler(instruction, label, line) {
    ...
    console_log(
        "Instruction parts after splitting: ",
        instructionParts,
        "DEBUG",
    )
    ...
    for (let i = 0; i < architecture.pseudoinstructions.length; i++) {
        console_log(
            "Checking pseudoinstruction: " +
                architecture.pseudoinstructions[i].name,
            "DEBUG",
        )
        if (architecture.pseudoinstructions[i].name != instructionParts[0]) {
            ...
            if (
                ...
                for (
                    ...
                    console_log(
                        "Current token being processed: " + token,
                        "DEBUG",
                    )
            ...
            if (found === true) {
                let code
                let value
                const { variables, prefix, cleanup } =
                    createVariables(definition)
                re = /aliasDouble\((.*)\)/
                for (
                    let a = 0;
                ...
                while (definition.search(re) != -1) {
                    ...
                    for (
                        var b = 0;
                        b < architecture.components[3].elements.length;
                        b++
                    ) {
                        console_log(
                            "Checking component element: " +
                                architecture.components[3].elements[b].name,
                            "DEBUG",
                        )
                        if (
                            architecture.components[3].elements[
                                b
                            ].name.includes(args[0]) !== false
                        ) {
                            aux =
                                architecture.components[3].elements[b]
                                    .simple_reg[args[1]]
                    ...
                    console_log(
                        "Updated definition after alias replacement: " +
                            definition,
                        "DEBUG",
                    )
                }
                ...
                for (let j = 1; j < signatureRawParts.length; j++) {
                    aux = signatureRawParts[j].replace(
                        /[.*+?^${}()|[\]\\]/g,
                        "\\$&",
                    )
                    re = new RegExp(aux, "g")
                ...
                if (definition.search(re) != -1) {
                    ...
                    definition = definition.replace(
                        "Field." + matchSize[1] + ".SIZE",
                        value,
                    )
                }

                console_log(
                    "Definition after field replacements: " + definition,
                    "DEBUG",
                )
                ...
                while (definition.search(re) != -1) {
                    ...
                    console_log(
                        "Definition after reg.pc replacement: " + definition,
                        "DEBUG",
                    )
                }
                ...
                while (definition.search(re) != -1) {
                    ...
                    console_log(
                        "No return operation match: " + match2[1],
                        "DEBUG",
                    )
                    ...
                    definition = definition.replace(re, "")
                    console_log(
                        "Definition after no_ret_op: " + definition,
                        "DEBUG",
                    )
                }
                ...
                while (definition.search(re) != -1) {
                    ...
                    console_log(
                        "Definition after operation replacement: " + definition,
                        "DEBUG",
                    )
                }

                console_log(
                    "Final definition before execution: " + definition,
                    "DEBUG",
                )
                ...
                try {
                    ...
                    console_log(
                        "Pseudo instruction compilation completed",
                        "DEBUG",
                    )
                    return ret
                } catch (e) {
